...
import { Bell, Grid, MessageCircle, MapPin, Search } from 'lucide-react';
...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full flex items-center justify-between px-12 py-6 border-b border-gray-300 bg-white text-xl">
      ...
      {/* Botão Entrar */}
      <button className="ml-8 mr-10 px-7 py-3 border border-gray-300 rounded-full text-xl font-bold hover:bg-gray-100 cursor-pointer">
        ENTRAR
      </button>
    </header>
  );
